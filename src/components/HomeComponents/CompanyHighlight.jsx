    ...
    <section className="relative mt-16 ">
      ...
      <div className="h-[70vh] flex items-end relative mb-16">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-1/2 flex gap-8 w-[90%] md:h-[80%] md:w-[80%]">
          ...
          <div className="w-1/3 bg-white p-6 rounded-xl shadow-2xl flex items-center justify-center border-2 border-green-300">
            <p
              className=" text-base md:text-2xl font-sans text-center font-medium bg-gradient-to-r from-green-400 to-blue-400 
